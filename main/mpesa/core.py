...
from .utils import encrypt_security_credential, format_phone_number, api_base_url, mpesa_config, \
    mpesa_response
from .b_utils import mpesa_access_token as b_token
from .utils import mpesa_access_token
...
class MpesaClient:
    ...
    def stk_push(self, phone_number, amount, account_reference, transaction_desc, callback_url):
        ...
        url = api_base_url() + 'mpesa/stkpush/v2/processrequest'
    ...
    def b2c_payment(self, phone_number, amount, transaction_desc, callback_url, occassion, command_id):
        ...
        business_short_code = mpesa_config('B_MPESA_SHORTCODE')
        ...
        print(initiator_security_credential)
        data = {
